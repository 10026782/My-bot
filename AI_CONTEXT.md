...
| Airtable schema drift — מתגלה ad-hoc per-bug (כך התגלה BUG-008: trailing space ב-`Business Outcome`) ולא דרך audit שיטתי; ייתכנו שדות singleSelect/multipleSelects נוספים עם drift דומה שלא התגלו עדיין | High | N07 Schema Governance script |
| אין CI/CD | Medium | N08 |
| אין Monitoring | Medium | N09 |
