...
8. **חדש: לברר burst קריאות Airtable** — נצפה 19/07/2026 באותה דגימה שסגרה את #393 (GET כפול לאותו contract_id, GET חוזר ל-meta/tables, 18 שורות Sessions ל-sender יחיד). לא אובחן עדיין — טרם ידוע אם ביצועי/עלות/duplication-bug אמיתי.
