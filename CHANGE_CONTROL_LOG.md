...
קבצים: `core/router/deterministic_denial.py` (חדש), `app.py`, `test_deterministic_denial.py` (חדש) | טרם PR (ענף `claude/new-session-yfiehv`) | באג: BUG-092
...
**Merged:** לא עדיין — קוד מוכן ונבדק. | **Verified בפרודקשן:** לא עדיין