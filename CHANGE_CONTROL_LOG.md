...
**Merged:** תלוי במיזוג PR (branch `claude/action-status-shadow-verification-m1m0ow`, restart-ed מ-`main` עדכני per merged-branch protocol — הענף המיועד המקורי כבר היה ממוזג במלואו) | **Verified בפרודקשן:** לא — התיקון טרם נצפה מול הודעת-ליד אמיתית עם מילת-דומיין אנגלית
