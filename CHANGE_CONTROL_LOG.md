...
**Merged:** כן (`bd0f32c`/`50847b7`, `42ed90c`/`0094a82`, `f367469`+`7526e60`/`fa08a58`, `8c720f4`+`69354c3`/`eaa01fa`, `8e6072e`/`def0a00`) | **Verified בפרודקשן:** ✅ כן — 08/07/2026, `/update` → נדל"ן (real_estate) → Other → טקסט → נשמר תקין, "📌 Other | נדל"ן" מוצג נכון, אין 422. שאר ה-domains עדיין לא נבדקו.