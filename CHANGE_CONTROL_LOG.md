...
### C172 — BUG-147: RP5 marker-only messages stripping to empty Anthropic content — fix + staging verification (20/07/2026)
...
**הערת מספור (ארבעה סבבים):** רשומה זו תויגה מקורית "C148"/"BUG-120" על ענף ה-RP5 לפני הרבייז הראשון; שני המספרים היו תפוסים ב-`main` ע"י פריטים בלתי-קשורים, אז נרשמה כ-C154/BUG-124 ברבייז ההוא. ברבייז **השני** (20/07/2026), "C154"/"BUG-124" עצמם התבררו כתפוסים ג"כ — נרשם מחדש כ-C155/BUG-125. ברבייז **השלישי** (22/07/2026), "C155" (תפוס — Cost Telemetry) ו-"BUG-125" (תפוס — `core/turn_evidence.py`) גם הם התבררו כתפוסים ב-`main` בינתיים — נרשם כ-C169/BUG-136. ברבייז **הזה, הרביעי** (24/07/2026), "C169" (תפוס — PR #449) ו-"BUG-136" (תפוס — "בצע שוב \<קוד\>") גם הם התבררו כתפוסים ב-`main` בינתיים דרך PR #449/#452/#456 — נרשם כאן מחדש כ-**C172/BUG-147** (המספרים הפנויים הבאים בפועל, אחרי C171/BUG-146 שכבר קיימים ב-`main`) — אותו דפוס בדיוק שכבר יושם ארבע פעמים בריפו הזה.
