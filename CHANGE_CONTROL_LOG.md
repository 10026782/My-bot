...
**Merged:** כן (`bd0f32c`/`50847b7`, `42ed90c`/`0094a82`, `f367469`+`7526e60`/`fa08a58`, `8c720f4`+`69354c3`/`eaa01fa`, `8e6072e`/`def0a00`) | **Verified בפרודקשן:** ✅ כן — 08/07/2026, `/update` נבדק ב-**כל 6** ה-domains (real_estate/SaaS/media/import/general/finance) → Other → טקסט → נשמר תקין בכולם, "📌 Other | <domain>" מוצג נכון, אין 422 באף אחד.