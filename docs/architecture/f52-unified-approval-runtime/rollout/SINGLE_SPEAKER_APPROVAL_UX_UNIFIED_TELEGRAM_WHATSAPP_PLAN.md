...
| R9 | Close remaining non-universal PR2 paths. | One snapshot; no ambiguous mutation; no Agent continuation. | R9.1 CODE_DONE / STATIC_VERIFIED | Reconfirmation, multi-contract, combined-command, TMA, and runtime/deployment work remain separate. |
