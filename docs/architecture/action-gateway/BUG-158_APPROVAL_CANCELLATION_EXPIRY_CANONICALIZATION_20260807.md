...
pending"). קוד מומש ונבדק מקומית (11/11 + regression מלא, ראה
`BUG_AUDIT_LOG.md`). **לא מוזג, לא deployed, לא verified בפרודקשן** —
כל שלושת אלה עדיין דורשים אימות נפרד לפי כלל הברזל.
