...
| Tokens/styles | Tailwind defaults; repeated gray/white/blue recipes | Existing 4/8/12/16 spacing and neutral surfaces | Implement the synthesized BOSS near-black canvas, dark surfaces, light pill actions, violet-blue accent, 4px rhythm, 4px cards, flat borders, focus, and motion recipes | Ventures-specific density calibration; semantic status palette |
