...
| Decision Hub | ACTIVE | STATIC AUDIT COMPLETE | YES | Stage 0–1 and formula-safety fixes are statically verified; DH-S1 CLOSED / STATIC VERIFIED; DH-S2 access-policy wording DOC/POLICY DRIFT / REMEDIATION REQUIRED; DH-S3 fail-closed reads STATIC VERIFIED; DH-S4 partial-persistence observability OPEN | REMEDIATION REQUIRED; runtime/deployment evidence NOT ESTABLISHED | align shared-capability policy/code/tests around permission, tenant/data scope and action authorization; remediate partial-persistence observability |
