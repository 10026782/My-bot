...
| Media | ACTIVE | MERGED + STATIC CLOSED (MECHANICAL FINDINGS) | YES | gateway/probe and staging artifacts merged; F16-M1, M2, M3, M4, M6, M7 all statically verified and merged; F16-M5 (content-hash architecture for non-TMA sources) remains open, blocked on a separate owner decision | owner decision on F16-M5 or explicit deferral, then deployed-SHA Media canary / runtime verification | resolve or defer the F16-M5 owner decision |
