...
as merged/static, with R5 shared field-choice primitive next. Runtime is not
implied. The registry rows below are reconciled to this decision and current
main evidence.
...
| UX_01_UNIFIED_BOSS_EXPERIENCE | UX-01 — Unified BOSS Experience | Product/UI (H6 Product UI) | H6 | ACTIVE | Implementation in progress through F52 / Single-Speaker Approval UX; UX-01 remains the canonical identity and is not replaced by F52 | MERGED | R5 — shared field-choice primitive; program completion remains pending | true | false | false | 2026-08-28T00:00:00Z | git:main:c8f1ab7;ROADMAP.md;docs/architecture/f52-unified-approval-runtime/rollout/SINGLE_SPEAKER_APPROVAL_UX_UNIFIED_TELEGRAM_WHATSAPP_PLAN.md |
