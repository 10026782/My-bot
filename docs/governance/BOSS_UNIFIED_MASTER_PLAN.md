...
| UX_01_UNIFIED_BOSS_EXPERIENCE | UX-01 — Unified BOSS Experience | Product/UI (H6 Product UI) | H6 | ACTIVE | Implementation in progress through F52 / Single-Speaker Approval UX; UX-01 remains the canonical identity and is not replaced by F52 | MERGED | Re-run uniformity gate after R6.1; program completion remains pending | true | false | false | 2026-08-28T00:00:00Z | git:main:40bc446;ROADMAP.md;docs/architecture/f52-unified-approval-runtime/rollout/SINGLE_SPEAKER_APPROVAL_UX_UNIFIED_TELEGRAM_WHATSAPP_PLAN.md |
