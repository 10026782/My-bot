...
| MEDIA_LAYER_F16 | Media Layer (F16) | Media/Context loop | H4 | ACTIVE | קוד ממוזג, flag off | MERGED | ליצור טבלת Media Files ידנית | true | false | false | 2026-08-16T00:00:00Z | BOSS_UNIFIED_MASTER_PLAN.md:§3.5:MEDIA_LAYER_F16:migration-explicit-status |
...
| COMMAND_CENTER_KNOWLEDGE_HUB | Command Center / Knowledge Hub | Product UI loop | H6 | PLANNED | טרם התחיל | PLANNED | תלוי ב-H1-H2 יציבים | false | false | false | 2026-08-16T00:00:00Z | BOSS_UNIFIED_MASTER_PLAN.md:§3.5:COMMAND_CENTER_KNOWLEDGE_HUB:migration-explicit-status |
