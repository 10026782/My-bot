...
| F52_UNIFIED_USER_MESSAGES | F52 Unified Approval Runtime — Unified User Messages | Message UX / Approval Runtime | H0 | ACTIVE | R3.2, R4, R4.1 and R6.1–R6.6 are merged/static; R7 WhatsApp adapter slices are active; F52 remains an active implementation program for UX-01 | MERGED | Continue R7 adapter slices; runtime/deployment verification remains separate | true | false | false | 2026-08-30T00:00:00Z | git:main:40bc446;PR#1088;PR#1091;git:main:3c45a87;docs/architecture/f52-unified-approval-runtime/rollout/SINGLE_SPEAKER_APPROVAL_UX_UNIFIED_TELEGRAM_WHATSAPP_PLAN.md |
...
| UX_01_UNIFIED_BOSS_EXPERIENCE | UX-01 — Unified BOSS Experience | Product/UI (H6 Product UI) | H6 | ACTIVE | Implementation in progress through F52 / Single-Speaker Approval UX; R7 WhatsApp adapter work is active; UX-01 remains the canonical identity and is not replaced by F52 | MERGED | Continue the gated R7 channel-adapter sequence; program completion remains pending | true | false | false | 2026-08-30T00:00:00Z | git:main:40bc446;ROADMAP.md;docs/architecture/f52-unified-approval-runtime/rollout/SINGLE_SPEAKER_APPROVAL_UX_UNIFIED_TELEGRAM_WHATSAPP_PLAN.md |
