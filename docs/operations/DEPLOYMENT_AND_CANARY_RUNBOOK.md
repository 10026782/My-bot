...
**Source:** `docs/operations/MASTER_VERIFICATION_MATRIX.md` (01/09/2026). **Truth Reset SHA:** `origin/main` = `894320409a67df992afedeb70aae8e76fdfd00d1`. **Type:** execution sequence for the next deployment window, derived directly from the matrix's per-capability "Canary Required"/"Runtime Evidence Required" columns.
