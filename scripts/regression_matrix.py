...
FULL_REGRESSION: list[str] = [
    ...
    "test_phase_4b_1b_concurrency.py",
...
SCENARIO_MATRIX: list[dict[str, str]] = [
    ...
    {"id": "R15", "category": "approval", "name": "duplicate", "file": "test_phase_4b_1b_concurrency.py"},
    {"id": "R16", "category": "callbacks", "name": "valid", "file": "test_pr0c_telegram_callback_gateway.py"},
    {"id": "R17", "category": "callbacks", "name": "expired", "file": "test_bug_approval_callback_hardening.py"},
    ...
    {"id": "R21", "category": "execution", "name": "idempotency", "file": "test_phase_4b_1b_concurrency.py"},
