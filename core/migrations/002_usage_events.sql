...
-- Cost Telemetry Reliability — durable usage event log
--
...
-- restart/redeploy — see docs/audit/POST_N15_WORK_SURVEY_20260720.md and
-- the cost-telemetry investigation this migration closes out).
--
...
-- new table or new columns. AI_Usage_Daily (Airtable) remains a narrow
-- projection derived FROM this table — see core/cost_watchdog.py — not a
