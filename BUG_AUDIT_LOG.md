...
## BUG-127C — A32 Single-Speaker מדכא תוצאת קריאה אמיתית ומאומתת (verified_read_only) ומחליף אותה בהודעת כישלון גנרית — 🔴 נרשם, נחקר חלקית, לא תוקן (ממתין להחלטת המשתמש — "לחקור אחרי 121B")
