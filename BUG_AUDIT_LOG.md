...
### BUG-092 — BUG-091 preflight נכון אך מאוחר מדי: סבב Claude מלא לפני חסימה ודאית (09/07/2026) — ✅ תוקן, טרם ממוזג
- **תאריך:** 09/07/2026
...
- **Merged:** לא עדיין — קוד מוכן, נבדק, ענף `claude/new-session-yfiehv` (נפתח מ-`origin/main` אחרי ש-PR #285/#286 כבר מוזגו).
- **Deployed/Verified בפרודקשן:** לא עדיין.
- **סטטוס:** ✅ תוקן בקוד במלואו, נבדק אמיתית (unit + e2e), טרם ממוזג.
