...
- **Merged:** ממתין ל-push/PR.
- **סטטוס:** ✅ תוקן בקוד, בדיקות עברו, במקום הנכון בפועל — ממתין ל-merge+production verification. **בדיקה חוזרת בפרודקשן חייבת להראות: (1) candidates נפרדים נכונים ל-3+ לידים כולל טלפון פגום אחד באמצע, (2) Summary/Lead Event של כל ליד מכיל רק את הטקסט שלו, לא של לידים אחרים.**
