...
- **Merged:** לא עדיין — ממתין ל-push/PR.
- **Deployed/Verified בפרודקשן:** לא עדיין.
- **סטטוס:** ✅ תוקן בקוד (101a+101b+101c, commit יחיד), רגרסיה מלאה ירוקה (29+16+9+44+1 smoke + 19 טסטים חדשים = 0 כשלים) — ממתין ל-merge+production verification. **099b נשאר חסום עד שזה יאומת בפרודקשן, לא רק ימוזג** (לפי תלות מפורשת שנקבעה מראש).