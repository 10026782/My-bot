...
| F52 | F52 Unified Approval Runtime — Unified User Messages | IN_PROGRESS | R4, R4.1 and R6.1 MERGED / STATIC VERIFIED; R6.2, R6.3 and R6.4 CODE_DONE / STATIC_VERIFIED; R5 GATE_COMPLETE — no new abstraction | Re-run uniformity gate after R6.4 | [`SINGLE_SPEAKER_APPROVAL_UX_UNIFIED_TELEGRAM_WHATSAPP_PLAN.md`](docs/architecture/f52-unified-approval-runtime/rollout/SINGLE_SPEAKER_APPROVAL_UX_UNIFIED_TELEGRAM_WHATSAPP_PLAN.md) |
