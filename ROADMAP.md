...
2 formula injection (BUG-DH-03/04) — תוקנו בקוד 07/07/2026, ✅ ממוזג ל-`main` (PR #251, commit `d51e6be`, מאומת עצמאית `git merge-base --is-ancestor 2e9bb57 origin/main` + `test_bugdh03_04_formula_injection.py` 15/15 הורץ בפועל 07/07/2026), עדיין 🟡 NOT PRODUCTION-VERIFIED — ראה סעיף BUG-DH-03/04 למטה — עדיפות גבוהה לפני הפעלת `FEATURE_DECISION_HUB`.
