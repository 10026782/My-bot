...
| DECISION_HUB | Decision Hub | IN_PROGRESS | ACTIVE / STATIC AUDIT COMPLETE / REMEDIATION REQUIRED / RUNTIME NOT ESTABLISHED — DH-S1 formula safety CLOSED / STATIC VERIFIED; DH-S2 access policy drift OPEN / OWNER DECISION REQUIRED; DH-S3 fail-closed reads STATIC VERIFIED; DH-S4 partial write observability OPEN | Resolve `DECISION_HUB_ACCESS_POLICY`, then align code/tests/docs; remediate partial-persistence observability | [`HORIZON.md`](docs/governance/HORIZON.md) |
