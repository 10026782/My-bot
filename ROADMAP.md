...
| F52 | F52 Unified Approval Runtime — Unified User Messages | IN_PROGRESS | R4, R4.1 and R6.1 MERGED / STATIC VERIFIED; R6.2, R6.3, R6.4, R6.5 and R6.6 CODE_DONE / STATIC_VERIFIED; R5 GATE_COMPLETE — no new abstraction | Merge R6.6, then continue only with the next gated consumer | [`SINGLE_SPEAKER_APPROVAL_UX_UNIFIED_TELEGRAM_WHATSAPP_PLAN.md`](docs/architecture/f52-unified-approval-runtime/rollout/SINGLE_SPEAKER_APPROVAL_UX_UNIFIED_TELEGRAM_WHATSAPP_PLAN.md) |
...
| UX-01 | Unified BOSS Experience | IN_PROGRESS | R0.1, R1.1, R2.0, R2.1, R3.1, R3.2, R4, R4.1 and R6.1 merged/static; R6.2, R6.3, R6.4, R6.5 and R6.6 CODE_DONE / STATIC_VERIFIED; R5 GATE_COMPLETE | Continue only with the next gated consumer | [`BOSS_UNIFIED_MASTER_PLAN.md`](docs/governance/BOSS_UNIFIED_MASTER_PLAN.md) §3.5 |
