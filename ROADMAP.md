...
| DECISION_HUB | Decision Hub | IN_PROGRESS | STATIC REMEDIATION COMPLETE / RUNTIME NOT ESTABLISHED. DH-S1 formula safety CLOSED / STATIC VERIFIED; DH-S2 access-policy wording DOC/POLICY DRIFT / REMEDIATION REQUIRED; DH-S3 fail-closed reads STATIC VERIFIED; DH-S4 partial write observability OPEN; DH-CB-01–DH-CB-09 CLOSED / STATIC VERIFIED with direct callback and scope regressions. Protected CLI paths remain positive evidence; runtime/deployment is not claimed. | Remediate DH-S4 partial-persistence observability; then pursue separately gated runtime evidence without broadening permissions | [`HORIZON.md`](docs/governance/HORIZON.md) |
