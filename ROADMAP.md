...
| SCHEMA_DATA_CONTRACTS | Schema / Data Contracts | IN_PROGRESS | MERGED_STATIC — live verification pending; corrected a stale Leads tier-field comment in tma_api.py against live Airtable schema (30/08/2026) | Perform live schema/contract verification | [`MAINTENANCE_AUDIT_LEDGER.md`](docs/governance/MAINTENANCE_AUDIT_LEDGER.md) |
