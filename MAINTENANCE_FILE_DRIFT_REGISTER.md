...
| # | Finding | Current state / evidence | Mark | Owner | Track 8 disposition (30/08/2026) | Track 8B live disposition (30/08/2026) |
|---|---|---|---|---|---|---|
...
| K2 | `resolve_identity()` None-assumption mismatch (never returns None vs documented hard-fail) | C05-C07 F8, deferred (= R-C06-8) | NEEDS_DATA_CONTRACT_AUDIT | #3/#15 | Out of Track 8 scope (identity, not a schema/table contract) — not re-verified, unchanged | Not investigated by Track 8B (identity, out of live-verification scope). |
